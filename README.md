...
**474 skills** across 22 directories. Counts and licence pins on this page are generated by [`scripts/generate_index.py`](./scripts/generate_index.py) and verified in CI, so they cannot drift from the tree.
