...
Inventory: **148 Node Playwright checks** across eight spec files and two browser
profiles (desktop Chromium and touch-enabled mobile Chromium), with no skips.
That is 74 distinct tests run at desktop 1440x900 and phone 390x844; the ten
...
HTTP cache behavior. The motion follow-up adds twenty checks (ten tests times
