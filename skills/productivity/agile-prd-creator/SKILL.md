---
name: agile-prd-creator
description: Generate comprehensive Product Requirements Documents (PRDs) for product managers. Use this skill when users ask to "create an agile PRD", "write product requirements", "document a feature", "plan a sprint", or need help structuring product specifications.
---
