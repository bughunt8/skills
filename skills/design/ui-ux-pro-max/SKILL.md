---
name: ui-ux-pro-max
description: Design and review professional web, mobile, or desktop interfaces using searchable UI styles, color palettes, typography, accessibility, chart, and stack-specific guidance.
---

# UI/UX Pro Max

UI/UX design intelligence for web, mobile, and desktop applications. It provides searchable styles, palettes, typography, accessibility guidance, charts, and stack-specific recommendations.
...
**Example:**
```bash
python3 skills/design/ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 skills/design/ui-ux-pro-max/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 skills/design/ui-ux-pro-max/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
```bash
python3 skills/design/ui-ux-pro-max/scripts/search.py "atlantafx primer enterprise theme" --stack javafx
python3 skills/design/ui-ux-pro-max/scripts/search.py "enterprise tableview density permission" --stack javafx
```
...
```bash
python3 skills/design/ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python3 skills/design/ui-ux-pro-max/scripts/search.py "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python3 skills/design/ui-ux-pro-max/scripts/search.py "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python3 skills/design/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack react-native
```
...
python3 skills/design/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python3 skills/design/ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
